...
namespace WebsiteWAPP
{
    public partial class createSummaries : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string book_query = "INSERT INTO books (book_title, category_name, book_author, book_publisher, book_isbn, book_summary) " +
                    "VALUES (@book_title, @category_name, @book_author, @book_publisher, @book_isbn, @book_summary)";
